...
class RemScriptClient {
     ...
     * @throws RemScriptProtocolError
     */
    function _requestData($post, $files = null){
        # Request
        $response = $this->_request($post, $files);
     ...
     */
    function call($method, $arguments = array(), $payload = null, $files = null){
        # Request
        $post = array(
            'method' => $method,
            'args' => $arguments,
        ...
        $response = $this->_requestData($post, $files);
        $data = $response->data;
